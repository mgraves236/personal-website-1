...
function setMouse(event) {
    ...
    console.log("LEFT  " + limit.left + " TOP " + limit.top);
    // touch screens
   //limit.top = limit.top + _pieces[0].height;
  // limit.left = limit.left + _pieces[0].width;
    ...
    /*if (Number.isNaN(mouse.x) || Number.isNaN(mouse.y)) {
        let touches = event.changedTouches;
        mouse.x = (touches[0].pageX - limit.left) * scaleX;
        mouse.y = (touches[0].pageY - limit.top) * scaleY - _puzzleHeight;
    }*/
